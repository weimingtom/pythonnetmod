...
namespace Python.Runtime
{
    public class Finalizer
    {
        ...
        public bool ThrowIfUnhandleIncorrectRefCount { get { return m_ThrowIfUnhandleIncorrectRefCount;} set { m_ThrowIfUnhandleIncorrectRefCount = value;} }
		private bool m_ThrowIfUnhandleIncorrectRefCount = true;
        #endregion
            ...
            if(Monitor.TryEnter(_collectingLock))
            {
                try
                {
                    if (!_pending)
                    {
                        ...
                        if (_finalizerTask != null) _finalizerTask.Wait();
